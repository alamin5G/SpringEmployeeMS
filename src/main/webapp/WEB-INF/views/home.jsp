			...
			<div class="col-md-12">
				<div class="card">
					...
					<c:if test="${not empty msgs }">
						<div class="bg-danger pt-2 text-center text-black rounded">
							<h5>${msgs }</h5>
						</div>
						<c:remove var="msgs" />
					</c:if>
							...
							<tbody>
								<c:forEach items="${employeeList }" var="employee">
									...
									<tr>
										...
										<td><a href="editingEmployee/${employee.id }"
											class="btn btn-sm bg-warning text-white">Edit</a> <a
											href="deleteingEmployee/${employee.id }"
